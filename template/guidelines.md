...
| specific_epithet        | <ReqIcon maybe/>                  | Specific epithet for the *species* to which belongs the identified taxon (e.g. `aquaticus` if species is *Asellus aquaticus*). Can be omitted if `taxon_rank` is species or above.                                                                                                                                                                                                                                                                                |
...
| identified_by           |                                   | A list of people responsible for the identification. Format: `last name, first name`, where `first name` is optional and can be initials. List separator is `\|`.                                                                                                                                                                                                                                                                                                 |
| verbatim_identification |                                   | Taxon name originally assigned to the occurrence for traceability purposes. Might be in agreement or contradiction with `taxon_name`.                                                                                                                                                                                                                                                                                                                             |
